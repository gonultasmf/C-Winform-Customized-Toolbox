...
namespace ToolBox
{
    class DSMenuRenderer : ToolStripProfessionalRenderer
    {
        //Fields
        ...
        //Constructor
        public DSMenuRenderer(bool isMainMenu, Color primaryColor, Color textColor)
            : base(new DSMenuColorTable(isMainMenu, primaryColor))
        {
