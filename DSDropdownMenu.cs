...
namespace ToolBox
{
    class DSDropdownMenu : ContextMenuStrip
    {
        //Fields
        ...
        //Constructor
        public DSDropdownMenu(IContainer container)
            : base(container)
        {
            container.Add(this);
        }
        ...
        protected override void OnHandleCreated(EventArgs e)
        {
            ...
            {
                this.Renderer = new DSMenuRenderer(isMainMenu, primaryColor, menuItemTextColor);
                LoadMenuItemHeight();
            }
        }
    }
